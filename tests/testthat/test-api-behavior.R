test_that("API auth and notes endpoints enforce expected behavior", {
  ...
  testthat::expect_equal(openapi$components$securitySchemes$bearerAuth$type, "http")
  testthat::expect_equal(openapi$components$securitySchemes$bearerAuth$scheme, "bearer")
  testthat::expect_true(!is.null(openapi$security))
  testthat::expect_equal(openapi$security[[1]]$bearerAuth, list())
  testthat::expect_equal(openapi$paths[["/health"]]$get$security, list())
  testthat::expect_equal(openapi$paths[["/swagger/"]]$get$security, list())
  testthat::expect_true(is.null(openapi$paths[["/notes"]]$get$security))
  testthat::expect_true(is.null(openapi$paths[["/hevy/status"]]$get$security))
